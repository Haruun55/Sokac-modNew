...
------------------ change this -------------------
DynamicWeather = false -- Set this to false if you don't want the weather to change automatically every 10 minutes.
...
RegisterCommand('freezetime', function(source, args)
    ...
    if source ~= 0 then
        if grupa == 'owner' or grupa == 'headadmin' or grupa == 'admin' then
