...
RegisterNetEvent('sSync:updateWeather')
AddEventHandler('sSync:updateWeather', function(NewWeather, newblackout)
...
Citizen.CreateThread(function()
    while true do
        ...
        Citizen.Wait(800) -- Wait 0 seconds to prevent crashing.
...
RegisterNetEvent('sSync:updateTime')
AddEventHandler('sSync:updateTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
...
AddEventHandler('playerSpawned', function()
    TriggerServerEvent('sSync:requestSync')
end)
...
RegisterNetEvent('sSync:notify')
AddEventHandler('sSync:notify', function(message, blink)
