...
function OpenCloakroomMenu()
		...
		TriggerEvent('nh-context:sendMenu', {
			{
				id = 1,
				header = "👨 >> Normalna odjeca",
				txt = "Vasa default odjeca!",
				params = {
					event = "normalodjeca:pd",
				}
				
			},
			{
				id = 2,
				header = "👮 >> Policiska uniforma",
				txt = "Vasa Uniforma!",
				params = {
					event = "pdodjeca:pd",
				}
...
AddEventHandler('normalodjeca:pd', function()
...
AddEventHandler('pancir:pd', function()
SetPedArmour(PlayerPedId(),100)
end)
AddEventHandler('pdodjeca:pd', function()
...
exports.qtarget:AddBoxZone("pdstock", vector3(453.34, -980.01, 30.69), 2, 2, {
    name="pdstock",
    heading=11.0,
    debugPoly=false,
    }, {
...
AddEventHandler('pdstock:pd', function()
	OpenArmoryMenu()
end)
	...
	TriggerEvent('nh-context:sendMenu', {
		{
			id = 1,
			header = "📦 >> Uzmi predmer",
			txt = "Uzmi te predmet iz skladista!",
			params = {
				event = "uzmipredmet:pd",
			}
			
		},
		{
			id = 2,
			header = "📦 >> Ostavi predmer",
			txt = "Ostavi predmet u skladiste!",
			params = {
				event = "ostavipredmet:pd",
			}
...
AddEventHandler('uzmipredmet:pd', function()
	OpenGetStocksMenu()
end)
AddEventHandler('ostavipredmet:pd', function()
	OpenPutStocksMenu()
end)
...
exports.qtarget:AddBoxZone("pdsvalcionica", vector3(452.27, -994.02, 30.69), 2, 2, {
    name="pdsvalcionica",
    heading=11.0,
    debugPoly=false,
    }, {
...
exports.qtarget:AddBoxZone("boss", vector3(447.33, -974.35, 30.69), 2, 2, {
    name="boss",
    heading=11.0,
    debugPoly=false,
    }, {
...
AddEventHandler('svlacionica:pd', function()
	OpenCloakroomMenu()
end)


AddEventHandler('zaposli:pd', function()
...
RegisterKeyMapping('+impound', 'POLICIJA IMPOUND', 'keyboard', 'E')
-- Main thread
...
Citizen.CreateThread(function()
    ...
    exports['qtarget']:AddTargetModel(pdgaraza, {
        options = {
            {
                event = "pdgaraza-bog",
                icon = "fas fa-car",
    ...
    RegisterNetEvent("pdgaraza-bog")
    AddEventHandler("pdgaraza-bog", function()
	...
	Citizen.CreateThread(function()
		...
		exports['qtarget']:AddTargetModel(obrisiautopd, {
			options = {
				{
					event = "obrisiautopd-bog",
					icon = "fas fa-car",
		...
		RegisterNetEvent("obrisiautopd-bog")
		AddEventHandler("obrisiautopd-bog", function()
			obrisi()
		end)
		function obrisi()
...
function OpenVehicleSpawnerMenu()
	...
	TriggerEvent('nh-context:sendMenu', {
		...
		},
		{
			id = 3,
			header = "🚔 >> Corveta",
			txt = "Brzina: 270km/h - Kocnice: 2/4 - Transmision: 3/4 ",
			params = {
				event = "vozilo3police",
			}
		...
		},
		{
			id = 4,
			header = "🚔 >> Motor",
			txt = "Brzina: 150km/h - Kocnice: 2/4 - Transmision: 3/4 ",
			params = {
				event = "vozilo4police",
			}
		...
		},
		{
			id = 5,
			header = "🚔 >> Dzip",
			txt = "Brzina: 200km/h - Kocnice: 2/4 - Transmision: 3/4 ",
			params = {
				event = "vozilo5police",
			}
		...
		},
		{
			id = 6,
			header = "🚔 >> Riot",
			txt = "Brzina: 100km/h - Kocnice: 2/4 - Transmision: 3/4 ",
			params = {
				event = "vozilo6police",
			}
...
AddEventHandler('vozilo1police', function()
	ESX.Game.SpawnVehicle("police", vector3(451.70, -1019.50, 28.43), 103.00, function(vehicle)
		TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
		SetVehicleMaxMods(vehicle)
...
AddEventHandler('vozilo2police', function()
	ESX.Game.SpawnVehicle("police", vector3(451.70, -1019.50, 28.43), 103.00, function(vehicle)
		TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
		SetVehicleMaxMods(vehicle)
		SetPedIntoVehicle(PlayerPedId(), vehicle, -1)
...
AddEventHandler('vozilo3police', function()
	ESX.Game.SpawnVehicle("police", vector3(451.70, -1019.50, 28.43), 103.00, function(vehicle)
		TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
		SetVehicleMaxMods(vehicle)
		SetPedIntoVehicle(PlayerPedId(), vehicle, -1)
...
AddEventHandler('vozilo4police', function()
	ESX.Game.SpawnVehicle("police", vector3(451.70, -1019.50, 28.43), 103.00, function(vehicle)
		TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
		SetVehicleMaxMods(vehicle)
		SetPedIntoVehicle(PlayerPedId(), vehicle, -1)
...
AddEventHandler('vozilo5police', function()
	ESX.Game.SpawnVehicle("police", vector3(451.70, -1019.50, 28.43), 103.00, function(vehicle)
		TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
		SetVehicleMaxMods(vehicle)
		SetPedIntoVehicle(PlayerPedId(), vehicle, -1)
...
AddEventHandler('vozilo6police', function()
	ESX.Game.SpawnVehicle("riot", vector3(451.70, -1019.50, 28.43), 103.00, function(vehicle)
		TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
		SetVehicleMaxMods(vehicle)
		SetPedIntoVehicle(PlayerPedId(), vehicle, -1)
		SetVehicleNumberPlateText(vehicle --[[ Vehicle ]], 'POLICIJA' --[[ string ]])
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	...
	if found then
		...
		ESX.ShowNotification("Spawnpoint je blokiran...")
		return false
	end
end
...
function ObrisiVozilo()
    ...
    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
    	...
    	ESX.ShowNotification("Potreban vam je posao policajac da biste vratili vozilo.")
    end
end
