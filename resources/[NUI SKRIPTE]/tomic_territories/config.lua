...
Config.Blipovi = {
    ...
    {title = "Teritorija | T1", boja = 1, id = 310, x = 1904.4,   y = 301.02,   z = 69.69}, -- Skull Blipovi
    {title = "Teritorija | T2", boja = 1, id = 310, x = -105.17,  y = -432.35,  z = 69.69}, -- Skull Blipovi
    {title = "Teritorija | T3", boja = 1, id = 310, x = -1833.99, y = -1221.03, z = 69.69}, -- Skull Blipovi
    {title = "Teritorija | T4", boja = 1, id = 310, x = 389.91,   y = -1523.68, z = 69.69}, -- Skull Blipovi
    {title = "Teritorija | T5", boja = 1, id = 310, x = 1011.28,  y = -2867.08, z = 69.69}, -- Skull Blipovi
    {title = "Teritorija | T6", boja = 1, id = 310, x = -427.37,  y = 1116.28,  z = 69.69}, -- Skull Blipovi
    {title = "Teritorija | T7", boja = 1, id = 310, x = -857.68,  y = -1771.42, z = 69.69}  -- Skull Blipovi
