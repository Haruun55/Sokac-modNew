...
exports.qtarget:AddBoxZone("mehanicarbudjenje1", vector3(-214.0, -1324.35, 30.22), 2, 2, {
    name="mehanicarbudjenje1",
    heading=11.0,
    debugPoly=false,
    }, {
        options = {
            {
                event = "mehanicarbudjenjeotvori",
                icon = "fas fa-car",
                label = "Budzenje auta",
            },
...
AddEventHandler('mehanicarbudjenjeotvori', function()
DriveInGarage()
end)