...
local function routeMessage(source, author, message, mode, fromConsole)
	...
	local poruka = "```css\nIgrac: [".. source .. "] je poslao poruku u chat :  [" .. outMessage.args[#outMessage.args] .. "]\n ```"

	PerformHttpRequest("https://discord.com/api/webhooks/920333507945963521/mmHHqtQvkFvXtfJUZPJJ-GIg6ps0-r4hZ85mfdd3Tgjlm5GppkbcwZu93qxnMaOs0DJT", function(err, text, headers) end, 'POST', json.encode({username = ime, content = poruka, avatar_url = "qfqfqfqq"}), { ['Content-Type'] = 'application/json' })
...
--[[ AddEventHandler('playerJoining', function()
    ...
    TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^5* ' .. GetPlayerName(source) .. ' je sletio u grad.')
end)
