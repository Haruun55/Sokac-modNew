...
plyState = LocalPlayer.state
local micClicks = SetResourceKvpInt('pma-voice_enableMicClicks', 0)

if not micClicks then
	SetResourceKvpInt('pma-voice_enableMicClicks', 0)
end
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		micClicks = value
		SetResourceKvpInt('pma-voice_enableMicClicks', micClicks)
	end
end
exports('getMicClicks', function()
	return micClicks
end)
exports('getRadioStatus', function()
	return radioEnabled
end)
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpInt('pma-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvpInt('pma-voice_enableMicClicks', 1)
	else
